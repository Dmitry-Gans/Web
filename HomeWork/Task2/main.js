...
// в которой подключить файл main.js (его тоже необходимо создать 
...
// его имя и вызвать функцию greeting, передав туда полученное от 
// пользователя значение.

const name = prompt("Введите имя и фамилию:");

function greeting (name1){

    return "Добро пожаловать " + name1 + "!";
